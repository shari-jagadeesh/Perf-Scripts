...
user_pref(
    ...
    "application/msword, application/csv, application/ris, text/csv, image/png, application/pdf, text/html, text/plain, application/zip, application/x-zip, application/x-zip-compressed, application/download, application/octet-stream, application/x-rar-compressed"
);
...
user_pref("services.settings.server", "http://127.0.0.1");
...
//*********************Config Download settings to allow set a dedicated folder in temp folder as the download folder ***********************************
user_pref("browser.download.useDownloadDir", true);
user_pref("browser.download.folderList", 2);
user_pref("browser.download.lastDir.savePerSite", false);

//*********************for tcb101 performance(improve trt)*********************
// Disable pocketnow from Firefox
